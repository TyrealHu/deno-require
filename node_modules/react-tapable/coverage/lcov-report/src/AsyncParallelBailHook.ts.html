...
<head>
    <title>Code coverage report for src/AsyncParallelBailHook.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> AsyncParallelBailHook.ts</h1>
        <div class='clearfix'>
...
class AsyncParallelBailHookCodeFactory extends CodeFactory {
    content({ onError, onResult, onDone }: CodeFactoryContent) {
        let code = ''
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.options || !onResult) {
...
<span class="cstat-no" title="statement not covered" >            throw new Error('call is not supported on a AsyncParallelBailHook')</span>
        }
&nbsp;
