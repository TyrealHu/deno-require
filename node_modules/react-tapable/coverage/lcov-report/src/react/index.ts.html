...
<head>
    <title>Code coverage report for src/react/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/react</a> index.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!hook) {
<span class="cstat-no" title="statement not covered" >            throw new Error(`hook doesn't exist in controller,it' s name : ${hooksName} `)</span>
        }
&nbsp;
        hook.call(...args)
        return
...
&nbsp;
<span class="fstat-no" title="function not covered" >    callAsync(</span>hooksName: keyof HooksMap, ...args: any[]): any {
        const hook = <span class="cstat-no" title="statement not covered" >this.getHook(hooksName)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!hook) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(`hook doesn't exist in controller,it' s name : ${hooksName} `)</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        hook.callAsync(...args)</span>
<span class="cstat-no" title="statement not covered" >        return</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    promise(</span>hooksName: keyof HooksMap, ...args: any[]): Promise&lt;any&gt; {
        const hook = <span class="cstat-no" title="statement not covered" >this.getHook(hooksName)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!hook) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(`hook doesn't exist in controller,it' s name : ${hooksName} `)</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return hook.promise(...args)</span>
    }
&nbsp;
    getHook(key: keyof HooksMap): Hook | undefined {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.hooks.hasOwnProperty(key)) {
...
&nbsp;
    getHooksNameMap(): Record&lt;string, string&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.hooks) {
<span class="cstat-no" title="statement not covered" >            return {}</span>
        }
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!hook) {
<span class="cstat-no" title="statement not covered" >            throwError(`tapHook Cannot find hook by key ${rawOptions.hook}`)</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (
            rawOptions.mode !== 'tap' &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >            rawOptions.mode !== 'tapAsync' </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >            rawOptions.mode !== 'tapPromise'</span>
        ) {
<span class="cstat-no" title="statement not covered" >            throwError(</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!hook) {
<span class="cstat-no" title="statement not covered" >            throwError(`removeTapHook Cannot find hook by key ${name}`)</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (mode !== 'tap' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >mode !== 'tapAsync' </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >mode !== 'tapPromise')</span> {
<span class="cstat-no" title="statement not covered" >            throwError(`removeTapHook mode must be tap/tapAsync/tapPromise, but get ${mode}`)</span>
        }
&nbsp;
...
export function createTapableController&lt;THooks extends Record&lt;string, string&gt;&gt;(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ControllerMap.has(name + globalId + '')) {
<span class="cstat-no" title="statement not covered" >        console.warn(`react-tapable: controller: ${name} has been registed, and it will be covered`)</span>
    }
&nbsp;
...
&nbsp;
    return {
        ...
        callAsync: <span class="fstat-no" title="function not covered" >(h</span>ooksName: keyof THooks, ...args: any[]) =&gt;
<span class="cstat-no" title="statement not covered" >            controller.callAsync(hooksName, ...args),</span>
        promise: <span class="fstat-no" title="function not covered" >(h</span>ooksName: keyof THooks, ...args: any[]) =&gt;
<span class="cstat-no" title="statement not covered" >            controller.promise(hooksName, ...args),</span>
        tapHook: (
            rawOptions: {
                once?: boolean
                hook: keyof THooks
