...
<head>
    <title>Code coverage report for src/AsyncSeriesHook.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> AsyncSeriesHook.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            throw new Error('call is not supported on a AsyncSeriesHook')</span>
        }
&nbsp;
